    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form method="POST" action="{{ Route('ingoings.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> اسم قسم الايرادات <span
                                    class="required">*</span>
                            </label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="parent_id" id="form_control_1">
                                    ...
                                    @foreach ($ingoings as $ingoing)
                                        <option value="{{$ingoing->id}}">{{$ingoing->name}}</option>
                                    @endforeach
                        ...
                        {{--                                        @foreach ($ingoings as $ingoing)--}}
                        {{--                                            <div class="item" data-value="{{ $ingoing->id }}">{{ $ingoing->name }}</div>--}}
                        {{--                                        @endforeach--}}
                        {{--                                    </div>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
