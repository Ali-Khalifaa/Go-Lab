            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{ Route('suppliers.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> التليفون <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> سجل تجارى <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="s_togary" id="s_togary" value="{{old('s_togary')}}"
                                       class="form-control col-md-7 col-xs-12" required>
                            </div>
                        </div>
