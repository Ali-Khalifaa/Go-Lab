                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{ Route('contacts.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> الرقم <span
                                    class="required">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="radio" name="is_whats" value="1"> واتس<br>
                                <input type="radio" name="is_whats" value="0"> عادى<br>
                            </div>
                        </div>
