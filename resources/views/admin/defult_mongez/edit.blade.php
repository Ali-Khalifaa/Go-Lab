...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/defult_mongez')}}">اعدادات خدمة طلب فى السريع </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل اعدادات خدمة طلب فى السريع </h1>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form method="POST" action="{{ url('admin/defult_mongez/'.$types->id) }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button class="btn btn-primary" type="button"><a href="{{url('/')}}/admin/defult_mongez"
