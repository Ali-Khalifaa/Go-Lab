            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                        ...
                        <!--        <input type="number" name="amount" value="" min="0" class="form-control"-->
                        ...
                        <!--<div class="form-row">-->
                        <!--    <div class="form-group col-md-2">-->
                        <!--        <label for="inputEmail4">تم دفع</label>-->
                        <!--        <input type="number" name="paid" value="" min="0" class="form-control" id="inputEmail4"-->
                        <!--               required>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <div class="clearfix"></div>
