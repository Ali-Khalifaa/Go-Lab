    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form method="POST" action="{{ url('admin/depts/'.$depts->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="hidden" name="user_id" id="user_id" value="{{ $depts->user_id }}"
                                       class="form-control col-md-7 col-xs-12" required>
                            </div>
                        </div>


                        <input type="hidden" name="order_id" id="order_id" value="{{ $depts->order_id }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="hidden" name="total" id="total" value="{{ $depts->total }}"
                                       class="form-control col-md-7 col-xs-12">
                                <label type="number" name="total" id="total" value="{{ $depts->total }}"
                                       class="form-control col-md-7 col-xs-12">{{ $depts->total }}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" name="paid" id="paid" value="{{ $depts->paid }}"
                                       class="form-control col-md-7 col-xs-12" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="discount"> التاريخ <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="date" id="date" value="{{ $depts->date }}"
                                       class="form-control col-md-7 col-xs-12" required>
                            </div>
                        </div>
