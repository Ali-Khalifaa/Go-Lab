    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form method="POST" action="{{ url('admin/offer_points/'.$offer_point->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" name="total" id="total" value="{{$offer_point->total}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="number"  name="points" id="points" value="{{$offer_point->points}}" class="form-control col-md-7 col-xs-12" required>
                            </div>
                        </div>
