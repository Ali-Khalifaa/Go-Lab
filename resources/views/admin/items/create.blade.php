    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form method="POST" action="{{ url('/admin/outgoings_item/store/'.$outgoing->id) }}"
                    ...
                    <!--        <input type="text" name="name" id="name" value="{{old('name')}}"-->
                        ...
                        <div class="form-group ">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form_control_1">المنخزن</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
...
{{--                        <div class="form-group">--}}
{{--                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category_id">المنخزن--}}
{{--                            </label>--}}
{{--                            <div class="col-md-6 col-sm-6 col-xs-12">--}}
{{--                                <select class="ui fluid search dropdown" name="store_id" id="members_dropdown"--}}
{{--                                        multiple="" required--}}
...
{{--                        </div>--}}
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="outgoing_id" id="form_control_1">

                                    @foreach ($outgoings as $out_going)
                                        <option
                                            value="{{ $out_going->id }}">{{ $out_going->name }}</option>
