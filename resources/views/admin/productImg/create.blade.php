...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('productImg.index',$product_id)}}"> صور المنتج </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>اضافة</span>
    ...
    <h1 class="page-title">أضافة صور للمنتج </h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('productImg.store')}}" role="form" class="form-horizontal"
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('productImg.index',$product_id)}}"
