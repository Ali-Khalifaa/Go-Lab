...
@section('content')
    ...
    <h1 class="page-title">تعديل مستخدم </h1>
...
{{--                        </div>--}}
                        ...
                        {{--        <div class="form-group">--}}
                        {{--            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">كلمة السر <span class="required">*</span>--}}
                        {{--            </label>--}}
                        {{--            <div class="col-md-6 col-sm-6 col-xs-12">--}}
                        {{--                <input  type="password"  name="password" id="password" value="{{old('password')}}" class="form-control col-md-7 col-xs-12" required>--}}
                        {{--            </div>--}}
                        {{--        </div>--}}
                        <div class="form-group">
                                                ...
                                                <div class="tab-pane {{$permission=='users'?'active':''}}"
                                                    ...
                                                    @foreach($maps as $map => $map_name)
                                                        <label><input type="checkbox" name="permissions[]"
                                                                      value="{{$map}}-{{$permission}}" {{$user->hasPermission($map.'-'.$permission)?"checked" :""}}>{{$map_name}}
                                                        </label>
                                                    @endforeach
                                                </div>
                                        @endforeach
